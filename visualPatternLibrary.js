...
const SCHEMATIC_CHOCH_BULL = [
  ...
  '  LH',
  '    ●╲',
  '      LL ●─── first higher high',
  '         ⇒ [Initial-direction reversal]',
  '         ╲   ╱',
  '          ● ╱',
  '           ●',
  '',
...
const PATTERNS = Object.freeze({
  ...
  bos: Object.freeze({
    ...
    level2Stub: 'Historical anchor pending — Corey Clone replay slot.',
    level3Stub: 'Live anchor pending — engine attaches the most recent [Structure Break] bar here.',
    plainEnglish: 'A [Structure Break] is the first candle that closes (full body) beyond a prior swing high (for a bullish break) or below a prior swing low (for a bearish break). It is the moment the structural read changes.',
    whyItMatters: 'A [Structure Break] is the first piece of evidence that a trend is extending — without a confirmed [Structure Break] the move is still inside the prior range.',
    ...
    commonMistakes: [
      'Treating any candle that exceeds the prior swing as a [Structure Break] — wicks do not count.',
      'Reading a [Structure Break] on a low timeframe as if it changed the higher-timeframe trend.',
      'Acting on the [Structure Break] bar itself rather than waiting for the calm retest or next confirmation.',
    ],
    atlasInterpretation: 'ATLAS treats a [Structure Break] as the structural anchor that unlocks trend-direction plays. The setup family that follows (calm retest, continuation) is what produces the actual entry; the [Structure Break] itself is the prerequisite.',
  ...
  choch: Object.freeze({
    ...
    slug: 'choch',
    anchorId: 'choch',
    name: '[Initial-direction reversal]',
    family: 'structural_event',
    direction: DIR.EITHER,
    level1Schematic: Object.freeze({
    ...
    level2Stub: 'Historical anchor pending — Corey Clone replay slot.',
    level3Stub: 'Live anchor pending — engine attaches the [Initial-direction reversal] bar here.',
    plainEnglish: 'An [Initial-direction reversal] is the first counter-trend break: an uptrend printing its first lower low, or a downtrend printing its first higher high. It is the earliest sign of a flip.',
    whyItMatters: 'An [Initial-direction reversal] signals that the prior trend has lost grip — the next [Structure Break] in the new direction tends to follow.',
    whatConfirms: 'A full candle body close beyond the most recent counter-trend swing, on the primary timeframe.',
    whatInvalidates: 'Price immediately reverses and resumes the prior trend with a fresh trend-direction [Structure Break].',
    commonMistakes: [
      'Trading the [Initial-direction reversal] bar itself — it is a warning, not an entry signal.',
      'Confusing an [Initial-direction reversal] on a low timeframe with a higher-timeframe character flip.',
      'Skipping the subsequent [Structure Break] in the new direction and acting on the [Initial-direction reversal] alone.',
    ],
    atlasInterpretation: 'ATLAS treats an [Initial-direction reversal] as a stand-down tell for the prior trend, not as a reverse-direction entry. Entries in the new direction require a follow-up structural event ([Structure Break], calm retest) on the operating timeframe.',
  ...
  continuation: Object.freeze({
    ...
    whatInvalidates: 'Pullback breaks the prior trend-direction swing point — read switches to potential [Initial-direction reversal].',
    commonMistakes: [
  ...
  exhaustion: Object.freeze({
    ...
    commonMistakes: [
      ...
      'Flipping to counter-trend trades on exhaustion without a follow-up [Initial-direction reversal] / [Structure Break] in the new direction.',
    ],
