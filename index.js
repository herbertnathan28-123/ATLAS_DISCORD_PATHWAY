...
async function fetchChartImage(symbol, iv) {
  ...
  const payload = JSON.stringify({
    ...
    // Confirmed override structure from chart-img.com v2 docs
    override: {
      style: {
        'candleStyle.upColor':        'rgb(0,255,120)',
        'candleStyle.downColor':      'rgb(255,30,30)',
        'candleStyle.borderUpColor':  'rgb(0,255,120)',
        'candleStyle.borderDownColor':'rgb(255,30,30)',
        'candleStyle.wickUpColor':    'rgb(0,220,100)',
        'candleStyle.wickDownColor':  'rgb(220,20,20)',
