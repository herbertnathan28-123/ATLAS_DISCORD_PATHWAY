...
const BANNED_PATTERNS = [
  ...
  [/No\s+entry\s+authorised/gi,                 'Entry not probable for this validity window'],
...
function filterBannedFromText(text) {
  ...
  const checks = [
    ...
    [/\bstand\s+aside\b/i,           'stand aside'],
    [/\bstand\s+down\b/i,            'stand down'],
    [/\bsideways\b/i,                'sideways'],
    [/\bNO\s+new\s+entries\b/i,      'NO new entries'],
