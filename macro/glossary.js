...
const TERMS = {
  ...
  market_driver: 'Market Driver — the upstream variable (US Dollar Index, market fear / volatility gauge, US Treasury yields, or a scheduled event) currently moving the market.',
