...
//       message with chart-reference embed
...
console.log('\n[T15] BUILDING + Chart Reference present as its own message');
{
  ...
  ok('Reference embed field "Rendered ATLAS chart cards" present',      refFieldNames.includes('Rendered ATLAS chart cards — next evolution'));
}
