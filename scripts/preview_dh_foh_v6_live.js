...
const checks = [
  ...
  ['M3 lifecycle separator uses amber boxed code block', /^```\n┌[\s\S]*🟧🟧 STILL ACTIVE/m.test(m3.content)],
  ...
  ['M4 lifecycle separator uses red-orange boxed code block', /^```\n┌[\s\S]*🟥🟧 FADING/m.test(m4.content)],
